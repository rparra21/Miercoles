                              ...
                              <div class="form-group">
                                 <div class="row">
                                      ...
                                      <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                                            <input type="text" name="url_update" class="form-control" id="url_update" placeholder="Please add the URL of the article" required>
                                      </div>  
                                  </div> 
                              </div>
                              <div class="form-group">
                                  <div class="row">
                                      ...
                                      <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                                            <input type="text" name="title_update" class="form-control" id="title_update" placeholder="Please add the title of the article" required>
                                      </div>  
                                  </div> 
                              </div>  
                              <div class="form-group">
                                 <div class="row">
                                      ...
                                      <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                                            <textarea class="form-control" name="snippet_update" id="snippet_update" placeholder="Enter a short description" required></textarea>
                                      </div>  
                                  </div> 
                              </div>  
                              <div class="form-group">
