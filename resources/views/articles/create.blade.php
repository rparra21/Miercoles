                        ...
                        <form id="formAdd" name="formAdd" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
                              ...
                              <div class="form-group">
                                 <div class="row">
                                      ...
                                      <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">      
                                                <input type="url" name="url" class="form-control" id="url" placeholder="Please add the URL of the article" required>                                                                                         
                                      </div>  
                              ...
                              <div class="form-group">
                                  <div class="row">
                                      ...
                                      <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                                            <input type="text" name="title" class="form-control" id="title" placeholder="Please add the title of the article" required>
                                      </div>  
                                  </div> 
                              </div>  
                              <div class="form-group">
                                 <div class="row">
                                      ...
                                      <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                                            <textarea class="form-control" name="snippet" id="snippet" placeholder="Enter a short description" required></textarea>
                                      </div>  
                                  </div> 
                              </div>  
                              <div class="form-group">
